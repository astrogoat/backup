...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/backup.css', 'vendor/backup')
...
// mix
    // .postCss('resources/css/backup.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    // .js('resources/js/backup.js', 'js')
    // .version()
